...
As part of my research, I am also involved in a STICERD-funded project on the development of migrants' access to employment across selected European countries over the last 30 years, together with Eiko Thielemann and Patrick McGovern. Recently, I have also published a data set with codified information on the refugee policies of 19 Latin American countries over the last 30 years. The dataset is available as an R-package here. 
